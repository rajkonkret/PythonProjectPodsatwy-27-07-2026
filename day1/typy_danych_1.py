...
print(2026 // 47)  # 43 - częśc całkowita z dzielenia
...
# bład zaokrąglenia
print(0.2 + 0.8)  # 1.0
print(0.2 + 0.7)  # 0.8999999999999999 -> 0.9
print(0.1 + 0.3)  # 0.4
...
# max_exp=1024, max_10_exp=308, min=2.2250738585072014e-308, min_exp=-1021, min_10_exp=-307, dig=15, mant_dig=53,
...
# bool() - rzytowanie na typ logiczny
print(bool(1))  # True
print(bool(0))  # False
...
print(None)  # odpowiednik null, stan nieokreslony, nie wiem
